...
namespace HackATL_Server.Migrations.SqlServerMigrations
{
    ...
    [Migration("20200627051756_ChatDataUpdate")]
    partial class ChatDataUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HackATL_Server.Models.Model.Chat_related.ChatRoom_participants", b =>
                {
                    ...
                    b.ToTable("chatRoom_Participants");
                });

            modelBuilder.Entity("HackATL_Server.Models.Model.Chat_related.UserChat", b =>
                {
            ...
            modelBuilder.Entity("HackATL_Server.Models.Model.Chat_related.UserChatList_Component", b =>
                {
                    ...
                    b.HasIndex("ChatRoom_participantsRId");
            ...
            modelBuilder.Entity("HackATL_Server.Models.Model.Chat_related.UserChatList_Group", b =>
                {
                    b.Property<string>("RId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HackATL_Server.Models.Model.Chat_related.UserChatList_LogHistory", b =>
                {
                    b.Property<string>("RId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HackATL_Server.Models.Model.Chat_related.UserChat_LogList", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HackATL_Server.Models.Model.Chat_related.User_chatlog", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HackATL_Server.Models.Model.authentication.PublicModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HackATL_Server.Models.Model.Chat_related.UserChatList_Component", b =>
                {
                    b.HasOne("HackATL_Server.Models.Model.Chat_related.ChatRoom_participants", null)
                        .WithMany("members")
                        .HasForeignKey("ChatRoom_participantsRId");

                    b.HasOne("HackATL_Server.Models.Model.Chat_related.UserChatList_Group", null)
                        .WithMany("UsersList")
            ...
            modelBuilder.Entity("HackATL_Server.Models.Model.Chat_related.UserChatList_Group", b =>
                {
                    b.HasOne("HackATL_Server.Models.Model.Chat_related.UserChat_LogList", null)
                        .WithMany("ChatList")
            ...
            modelBuilder.Entity("HackATL_Server.Models.Model.Chat_related.UserChatList_LogHistory", b =>
                {
                    b.HasOne("HackATL_Server.Models.Model.Chat_related.UserChat", null)
                        .WithMany("ChatLog")
            ...
            modelBuilder.Entity("HackATL_Server.Models.Model.Chat_related.User_chatlog", b =>
                {
                    b.HasOne("HackATL_Server.Models.Model.Chat_related.UserChatList_LogHistory", null)
                        .WithMany("Log")
